    ...
    public class NZWalksDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty()
                {
                    Id = Guid.Parse("f82ddda6-678a-4bc5-a83d-9520ea3859d7"),
                    Name = "Easy"
                },
                new Difficulty()
                {
                    Id = Guid.Parse("6521fad2-9864-41a8-88f5-8bd8c29df5f7"),
                    Name = "Medium"
                },
                new Difficulty()
                {
                    Id = Guid.Parse("8eb957dc-0480-4610-a680-a956f08e9f91"),
                    Name = "Hard"
                }
            };
